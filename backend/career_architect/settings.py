"""
Django settings for career_architect project.
"""
...
ROOT_URLCONF = 'career_architect.urls'
...
WSGI_APPLICATION = 'career_architect.wsgi.application'
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'career_architect'),
...
# CORS settings
CORS_ALLOWED_ORIGINS = ['http://localhost:3000', 'http://127.0.0.1:3000', 'http://localhost:5173', 'http://127.0.0.1:5173', 'http://localhost:5174', 'http://127.0.0.1:5174']
